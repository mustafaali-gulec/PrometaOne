...
app.use(
  ...
  cors({
    ...
    // adı) otomatik kabul edilir; saas'ta yalnız açık liste. (corsPolicy.ts —
    // api-server ile eş politika)
    ...
    // X-Terminal-*: koltuk lisansı başlıkları — çapraz-origin istemciler için.
