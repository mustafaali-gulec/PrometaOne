 ...
 *
 * Frontend `frontend/src/shared/fx/fxCore.ts` ve api-server `src/shared/fx/FxInfo.ts`
 * ile AYNI sözleşme; migration construction-service/migrations/004_fx_currency_fields.sql
 * ile aynı kolon adları:
 *
 ...
 * yapmaz.
 *
 * NOT: construction-service BAĞIMSIZ mikroservistir (kendi DB'si, kendi derlemesi).
 * Bu dosya api-server/src/shared/fx/FxInfo.ts'in bilinçli kopyasıdır — currency_code
 * ENUM'unun kopyalanmasıyla aynı gerekçe. Sözleşme değişirse İKİSİ birlikte güncellenir.
 *
