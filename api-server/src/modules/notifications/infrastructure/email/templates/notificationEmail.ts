...
<style>
  ...
  .header { background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); padding: 20px; color: #fff; }
  .header h1 { margin: 0; font-size: 18pt; }
  .header .subtitle { opacity: 0.9; font-size: 11pt; margin-top: 4px; }
  .body { padding: 20px; }
  .body h2 { color: #2563eb; font-size: 13pt; margin-top: 0; }
  .body p { line-height: 1.6; font-size: 11pt; }
  .cta { display: inline-block; padding: 10px 20px; background: #2563eb; color: #fff !important; text-decoration: none; border-radius: 4px; font-weight: 700; margin-top: 12px; }
